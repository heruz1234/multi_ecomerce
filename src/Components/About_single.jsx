...
export default function About_single({item}) {
  return (
    <div className='flex flex-col gap-3'>
      <div className='flex items-center flex-col gap-2 pb-3 border-b-1 border-black '>
      ...
      <div className='flex flex-col items-center  gap-4 pb-3 border-b-1 border-black '>
        <ul className='flex justify-between gap-38 lg:gap-2 capitalize font-medium '>
            <li>select size</li>
            <li>size chart</li>
        </ul>
      ...
      <div className='flex flex-col items-center  font-medium gap-2 pb-3 border-b-1 border-black '>
      ...
      <div className='flex justify-center  gap-2 pb-3 text-white font-medium text-l uppercase '>
